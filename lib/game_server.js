...
exports.listen = function(server) {
  db = mongojs('mongodb://soap:5102paoS@45.62.113.134:27017/infecteddb', ['profiles'])
  ...
  io.on('connection', function(socket) {
    ...
    socket.on('position', function(position) {
      ...
      for (var id in globalSpores[user.name]) {
        var spore = globalSpores[user.name][id]
